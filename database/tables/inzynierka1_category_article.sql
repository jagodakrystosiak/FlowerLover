...
CREATE TABLE `category_article` (
  ...
  KEY `FK1xhthmki8trq5j5g8cy8fc2i4` (`article_id`),
  CONSTRAINT `FK1xhthmki8trq5j5g8cy8fc2i4` FOREIGN KEY (`article_id`) REFERENCES `category` (`id`),
  CONSTRAINT `FKn67a792bhb4aqdodwre669jj1` FOREIGN KEY (`category_id`) REFERENCES `article` (`id`)
