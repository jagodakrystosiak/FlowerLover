...
CREATE TABLE `category_post` (
  ...
  KEY `FKl0osdd2e4pxlwqwpv91e2yihq` (`post_id`),
  CONSTRAINT `FKl0osdd2e4pxlwqwpv91e2yihq` FOREIGN KEY (`post_id`) REFERENCES `category` (`id`),
  CONSTRAINT `FKskqdt5o4gulvbxd6ghes8u0k8` FOREIGN KEY (`category_id`) REFERENCES `post` (`id`)
